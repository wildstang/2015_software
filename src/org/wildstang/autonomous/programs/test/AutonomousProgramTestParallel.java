...
public class AutonomousProgramTestParallel extends AutonomousProgram {
	...
	public void defineSteps() {
		AutonomousParallelStepGroup parallelGroup = new AutonomousParallelStepGroup(
				"Test parallel step group");
		parallelGroup.addStep(new AutonomousStepDriveManual(
				AutonomousStepDriveManual.KEEP_PREVIOUS_STATE, 1.0));
		parallelGroup.addStep(new AutonomousStepDelay(250));
		parallelGroup.addStep(new AutonomousStepDriveManual(1.0,
				AutonomousStepDriveManual.KEEP_PREVIOUS_STATE));
