 ...
 * @author Nathan
 */
public class AutonomousStepStartDriveUsingMotionProfileAndHeading extends
		AutonomousStep {
	...
	public AutonomousStepStartDriveUsingMotionProfileAndHeading(
			double distance, double goal_velocity, double heading) {
	...
	public void initialize() {
		((DriveBase) SubsystemContainer.getInstance().getSubsystem(
				...
				.startMoveWithHeadingAndMotionProfile(distance, goal_velocity,
						heading);
		finished = true;
	}
