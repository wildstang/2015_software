...
public class JoystickAxisEnum implements IInputEnum {
	...
	// Manipulator Enums
	public static final JoystickAxisEnum MANIPULATOR_LIFT = new JoystickAxisEnum(false, LEFT_JOYSTICK_Y, "MANIPULATOR_FRONT_ARM_CONTROL");
	...
	static {
		...
		manipulatorAxes[LEFT_JOYSTICK_Y] = MANIPULATOR_LIFT;
