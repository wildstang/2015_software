...
public class AutoMovementAccumulateBackArm extends AutoMovement {
	...
	protected ArmPreset startPositionBackArmAccumulate = new ArmPreset(0, 90,
			"AutoMovementAccumulateBackArm.StartPosition");
	protected ArmPreset endPositionBackArmAccumulate = new ArmPreset(0, 0,
			"AutoMovementAccumulateBackArm.EndPosition");
