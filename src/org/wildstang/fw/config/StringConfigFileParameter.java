 ...
 */
package org.wildstang.fw.config;
...
public class StringConfigFileParameter extends ConfigFileParameter {
	 ...
	 *
	 * @param cName
	 *            The class name to get
	 * @param pName
	 *            The parameter name get
	 * @param defValue
	 *            A default value for the parameter.
	 */
	public StringConfigFileParameter(String cName, String pName, String defValue) {
		super(cName, pName);
	...
	public String getValue() {
		...
		try {
			return ConfigManager.getInstance().getConfigParamByName(fullName);
		} catch (Throwable e) {
