...
import org.wildstang.fw.types.DataElement;
...
public class ConfigManager {
	...
	private static List<DataElement> config = new ArrayList<>();
	...
	public void readConfig() throws ConfigManagerException {
		try {
			config = ConfigManagerImpl.readConfig(configFileName);
	 ...
	 * @param configItem
	 *            A String representing the config item to parse
	 */
