...
import org.wildstang.fw.config.StringConfigFileParameter;
import org.wildstang.fw.types.Level;
...
public class Logger {
	 ...
	 * @param id
	 *            A unique identifier per class for easy debugging.
	 * @param message
	 *            The message to log.
	 */
	 ...
	 * @param c
	 *            The name of the class that is logging the message
	 * @param id
	 *            A unique identifier per class that allows easier debugging.
	 * @param message
	 *            The actual message. Most likely a string.
	 */
	protected void logMessage(Level l, String c, String id, Object message) {
		...
		if (l.toInt() == Level.FATAL_INT) {
			...
			// TODO: put reset code in here. Not sure how to handle this in
			// Java.
			// Is there an exception to throw, or some function to call to
			// assert
			// some value.
		}
